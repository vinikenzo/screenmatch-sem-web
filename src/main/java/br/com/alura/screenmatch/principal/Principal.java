...
public class Principal {
    ...
    private void topEpisodiosPorSerie() {
        ...
        if(serieBusca.isPresent()){
            ...
            topEpisodios.forEach(e -> System.out.printf("Série: %s Temporada %s - Episódio %s - Avaliação %s - %s\n",
                    e.getSerie().getTitulo(), e.getTemporada(), e.getNumero(), e.getAvaliacao(), e.getTitulo()));
        }
    ...
    private void filtrarSeriesPorTemporada() {
        ...
        List<Serie> seriesFiltradas = repositorio.seriePorTemporadaEAvaliacao(totalTemporadas, avaliacao);
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Qual é o gênero a ser buscado: ");
