...
public class Principal {
    ...
    private final String API_KEY = "&apikey=5afa62a";
    ...
    public void exibieMenu(){
        ...
        /*List<String> nomes = Arrays.asList("Messi", "Neymar", "Mbappe", "DiMaria", "Donnaruma");
...
//
        ...
        System.out.println("Melhor epísódio: " + est.getMax());
        System.out.println("Pior epísódio: " + est.getMin());
